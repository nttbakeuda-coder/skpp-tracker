        ...
        <div className="footer-top">
          ...
          <div>
            ...
            <div className="footer-addr">
              ...
              <br />
              <a href="https://bakeuda.nttprov.go.id/web/home?m=MQ==" target="_blank" rel="noopener">
          ...
          <div>
            ...
            <div className="sosmed-list">
              ...
              <a href="https://www.tiktok.com/@bkeuda.ntt" className="sosmed-a" target="_blank" rel="noopener">
              ...
              <a href="https://youtube.com/@bkeudantt?si=O-0w6nx8xTTUWhGH" className="sosmed-a" target="_blank" rel="noopener">
